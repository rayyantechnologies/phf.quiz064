                    ...
                    <li class="list-group-item my-16pt mb-lg-48pt">
                        ...
                        <div class="page-separator">
                            <p class="measure-lead-max text-90 text-black-70">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae minima reiciendis itaque. Accusantium sed itaque excepturi minima? Officia incidunt magni nobis ullam iure totam expedita, quo blanditiis consequatur quos. Nihil.
                            </p>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input id="customCheck01" type="checkbox" class="custom-control-input" />
                                <label for="customCheck01" class="custom-control-label">Ability to use newer syntax
                                    and offers reliability</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label for="customCheck03" class="custom-control-label">Usage of missing
                                    features</label>
                            </div>
                        </div>
                    </li>
